...
const uint16_t copper_list[]   = {
    COP_MOVE(0x0F00, XR_COLOR_ADDR+0x0),
    COP_MOVE(0x0400, XR_COLOR_ADDR+0xA),
    COP_VPOS(160),
    COP_MOVE(0x00F0, XR_COLOR_ADDR+0x0),
    COP_MOVE(0x0040, XR_COLOR_ADDR+0xA),
    COP_VPOS(320),
    COP_MOVE(0x000F, XR_COLOR_ADDR+0x0),
    COP_MOVE(0x0004, XR_COLOR_ADDR+0xA),
    COP_END()
};
#endif
