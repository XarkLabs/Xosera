...
#define XR_VERSION    0x09        // (RO  ) Xosera optional feature bits [15:8] and version code [7:0] [TODO]
#define XR_GITHASH_H  0x0A        // (RO  ) [15:0] high 16-bits of 32-bit Git hash build identifier
#define XR_GITHASH_L  0x0B        // (RO  ) [15:0] low 16-bits of 32-bit Git hash build identifier
#define XR_VID_HSIZE  0x0C        // (RO  ) native pixel width of monitor mode (e.g. 640/848)
#define XR_VID_VSIZE  0x0D        // (RO  ) native pixel height of monitor mode (e.g. 480)
#define XR_VID_VFREQ  0x0E        // (RO  ) update frequency of monitor mode in BCD 1/100th Hz (0x5997 = 59.97 Hz)
