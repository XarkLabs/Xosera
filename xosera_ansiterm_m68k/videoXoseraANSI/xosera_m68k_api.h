...
// uint16_t xosera_aud_channels();       // return number of audio channels (typically 4, or zero if disabled)

typedef struct _xosera_info xosera_info_t;        // forward declare Xosera info structure

// external function declarations
bool xosera_init(int reconfig_num);                // reset Xosera (if reconfig 0 to 3) and check Xosera is present
...
int  xosera_aud_channels();                        // return number of audio channels (typically 4, or zero if disabled)
